...
We first set our tick rate to 60 frames using the built-in `clock.tick()` function. The frame rate is how often we redraw the scene per second and the main deciding factor in how fluid your game feels. The high
...
Insert at the end of your game loop:
