...
## Resources
- [Workshop Recording](): will be posted after workshop
- [Starter Code](https://github.com/mpara3/sosp22-flask)
- [Completed Code](): will be posted after workshop
...
This code allows you to create a simple JSON object containing things that make you happy. Now, when we navigate to the ``/favcat`` URL on our Express server, we'll see the results of our GET request. 
